...
Ntx=4500# Número de símbolos OFDM que serão gerados.
...
model.add(Dense(Np*2, kernel_initializer=initializer))
...
#%%  Plot PAPR x CCDF and Epochs x Loss:

'''
#complex_no_8_16 = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_8_16.csv', ind_complex_no, delimiter=',')

complex_no_4_16 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_4_16.csv', delimiter=',')
complex_no_5_16 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_5_16.csv', delimiter=',')
complex_no_6_16 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_6_16.csv', delimiter=',')
complex_no_7_16 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_7_16.csv', delimiter=',')
complex_no_8_16 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_8_16.csv', delimiter=',')

complex_no_4_32 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_4_32.csv', delimiter=',')
complex_no_5_32 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_5_32.csv', delimiter=',')
complex_no_6_32 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_6_32.csv', delimiter=',')
complex_no_7_32 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_7_32.csv', delimiter=',')
complex_no_8_32 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_8_32.csv', delimiter=',')

complex_no_4_64 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/ind_complex_no.csv', delimiter=',')
complex_no_5_64 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_5_64.csv', delimiter=',')
complex_no_6_64 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_6_64.csv', delimiter=',')
complex_no_7_64 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_7_64.csv', delimiter=',')
complex_no_8_64 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_8_64.csv', delimiter=',')

complex_no_5_128 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_5_128.csv', delimiter=',')
complex_no_6_128 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_6_128.csv', delimiter=',')
complex_no_7_128 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_7_128.csv', delimiter=',')
complex_no_8_128 = np.loadtxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/complex_no_8_128.csv', delimiter=',')

vetor1 = np.mean(np.array(complex_no_4_16).astype(int))
vetor2 = np.mean(np.array(complex_no_5_16).astype(int))
vetor3 = np.mean(np.array(complex_no_6_16).astype(int))
vetor4 = np.mean(np.array(complex_no_7_16).astype(int))
vetor5 = np.mean(np.array(complex_no_8_16).astype(int))

vetor5 = np.mean(np.array(complex_no_4_32).astype(int))
vetor6 = np.mean(np.array(complex_no_5_32).astype(int))
vetor7 = np.mean(np.array(complex_no_6_32).astype(int))
vetor8 = np.mean(np.array(complex_no_7_32).astype(int))
vetor9 = np.mean(np.array(complex_no_8_32).astype(int))

vetor10 = np.mean(np.array(ind_complex_no).astype(int))
vetor11 = np.mean(np.array(complex_no_5_64).astype(int))
vetor12 = np.mean(np.array(complex_no_6_64).astype(int))
vetor13 = np.mean(np.array(complex_no_7_64).astype(int))
vetor14 = np.mean(np.array(complex_no_8_64).astype(int))

#vetor15 = np.mean(np.array(complex_no_5_128).astype(int))
#vetor16 = np.mean(np.array(complex_no_6_128).astype(int))
#vetor17 = np.mean(np.array(complex_no_7_128).astype(int))
#vetor18 = np.mean(np.array(complex_no_8_128).astype(int))

num_portadoras = np.arange(16, 66, 2)
papr_alvo = np.linspace(5, 8, 25) 

X, Y = np.meshgrid(num_portadoras, papr_alvo)

Z = np.array([media_16, media_18, media_20, media_22, media_24, media_26, media_28, media_30,
              media_32, media_34, media_36, media_38, media_40, media_42, media_44, media_46,
              media_48, media_50, media_52, media_54, media_56, media_58, media_60, media_62, media_64]).T
...
CCDF_PTS_PTS = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/CCDF_PTS_PTS.csv', CCDF_PTS_re, delimiter=',')
_CCDF_Pil_NN = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/_CCDF_Pil_NN.csv', _CCDF_Pil, delimiter=',')
CCDF_red_no_MCSA = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/CCDF_red_no_MCSA.csv', CCDF_red_no, delimiter=',')
_CCDF_original = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/_CCDF_original.csv', _CCDF, delimiter=',')
papr_min_PTS = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/papr_min_PTS.csv', papr_min, delimiter=',')
_PAPR_dB_Pil_NN = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/_PAPR_dB_Pil_NN.csv', _PAPR_dB_Pil, delimiter=',')
PAPR_final_no_MCSA = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/PAPR_final_no_MCSA.csv', PAPR_final_no, delimiter=',')
_PAPR_dB_original = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/_PAPR_dB_original.csv', _PAPR_dB, delimiter=',')
loss_training = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/loss_training.csv', history.history['loss'], delimiter=',')
Val_loss_training = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/Val_loss_training.csv', history.history['val_loss'], delimiter=',')
accuracy_training = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/accuracy_training.csv', history.history['accuracy'], delimiter=',')
val_accuracy_training = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/val_accuracy_training.csv', history.history['val_accuracy'], delimiter=',')
ebno_dbs = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/ebno_dbs.csv', ebno_dbs, delimiter=',')
BER_Original_teo = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/BER_Original_teo.csv', BER_THEO, delimiter=',')
BER_MCSA_Theoretical = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/BER_MCSA_Theoretical.csv', BER_THEO_des, delimiter=',')
BER_Simulation_Original = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/BER_Simulation_Original.csv', BER_SIM, delimiter=',')
BER_Neural_Network = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/BER_Neural_Network.csv', BER_SIM_Pil, delimiter=',')
BER_SIM_PTS = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/BER_SIM_PTS.csv', BER_SIM_PTS, delimiter=',')
BER_SIM_MCSA = np.savetxt('/Users/bianc/OneDrive/Mestrado_1/Python_code/BER_SIM_MCSA.csv', BER_SIM_Without, delimiter=',')
